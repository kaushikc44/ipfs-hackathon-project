...
function Upload() {
  ...
  function makeStorageClient() {
    return new Web3Storage({
      token:
        "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiJkaWQ6ZXRocjoweDhBNEUwN2VCNEQ5ZDZCZGZCODk2M2IwNzZCMDQzMGU3NDU4YzZEOEIiLCJpc3MiOiJ3ZWIzLXN0b3JhZ2UiLCJpYXQiOjE2Njk3OTgwNTM5MTksIm5hbWUiOiJJbml0aWFsIElGUFMifQ.PinAMyv3tEdaJ3TOpPDe-yDX8wtDkRrpEXnPIqVqAKE",
    });
  }
  let files = "";
